...
# -*- coding: utf-8 -*-
"""
🎬 Test Video Selector & Player (Automatic Sequence & Loop Edition)
====================================================================
Automatically scans the 'testVideo' folder and displays a clean menu.
1. The user selects a video number to play.
2. After the video ends, it automatically returns to the menu.
3. Option '0' plays ALL videos sequentially, AUTOMATICALLY moving to the
   next video without asking for user input or pressing Enter!
4. Pressing ESC immediately stops playback and returns to the menu.
"""
...
def get_video_list(folder='testVideo'):
...
def display_menu(videos):
    print("\n" + "=" * 70)
    print("  🎬  HRI Gesture Detection — Test Video Player (ACCURATE)")
    print("=" * 70)
...
def main():
    while True:
        videos = get_video_list('testVideo')
